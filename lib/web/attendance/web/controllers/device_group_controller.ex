defmodule Attendance.DeviceGroupController do
  ...
  def create(conn, %{"device_group" => device_group_params}) do
    current_user_id = get_session(conn, :current_user).id
    changeset = DeviceGroup.changeset(%DeviceGroup{employee_max_fingerprints: 1000, fingerprints_limit: 2, fingerprint_security: 3, user_id: current_user_id}, device_group_params)
